# src/publishers/unstructured_data_publisher.py
...
# Ganti dengan nama file data tidak terstruktur Anda
        ...
        with open(file_path, mode='r', encoding='utf-8') as csvfile:
            ...
            for i, row in enumerate(csv_reader):
                ...
                message_payload = {
                    ...
                    # "original_row_number": i # Opsional
                }
                
                producer_instance.send(topic_name, value=message_payload)
                print(f"Sent: {str(message_payload)[:100]}...")
                message_count += 1
