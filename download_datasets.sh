...
echo "Memastikan folder data/raw/ tersedia..."

mkdir -p data/raw

# Fungsi untuk mengecek apakah kaggle CLI terinstall
check_kaggle_cli() {
...
# Fungsi untuk mengecek kaggle.json
check_kaggle_config() {
...
# Mengecek prerequisites
echo "🔍 Mengecek Kaggle CLI..."
check_kaggle_cli
check_kaggle_config
echo "✅ Kaggle CLI siap digunakan"

# Download Global Health Statistics Dataset
echo ""
...
# Download Medical Abstract Classification Dataset
echo ""
...
echo ""
echo "📊 Menampilkan isi folder data/raw/:"
ls -la data/raw/

echo ""
echo "🎉 Proses download selesai!"
echo "Dataset tersimpan di folder data/raw/"